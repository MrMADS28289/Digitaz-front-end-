...
const Footer = () => {
    return (
        <footer className='pt-20 bg-gray-400'>
            <footer class="footer p-10 bg-gray-400 text-base-content font-bold">
                <div>
            ...
            <footer class="footer items-center p-4 bg-gray-500 text-neutral-content">
            ...
            <footer class="footer p-10 bg-gray-400 text-neutral-content">
                <div>
